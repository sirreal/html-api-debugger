...
html_api_debugger_cutover_assert_same( 'plugin version constant is cache-busted', '3.4', HTML_API_Debugger\VERSION );
...
foreach ( $test_modules as $id => $module ) {
	html_api_debugger_cutover_assert_same( "module {$id} uses version 3.4", '3.4', $module['version'] );
}
html_api_debugger_cutover_assert_same(
...
html_api_debugger_cutover_assert_same( 'debugger stylesheet uses version 3.4', '3.4', $test_styles['html-api-debugger']['version'] );
